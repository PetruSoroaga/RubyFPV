...
static u32 s_long_key_press_delta = 800;
...
int hardware_getBoardType()
{
   ...
   if ( strcmp(szBuff, "a03111") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "a03112") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "a03113") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "a03114") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "a03115") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "a03116") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "b03111") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "b03112") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "b03114") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "b03115") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "b03116") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "c03111") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "c03112") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "c03114") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "c03115") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "c03116") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "d03114") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "d03115") == 0 ) { board_type = BOARD_TYPE_PI4B;}
   if ( strcmp(szBuff, "d03116") == 0 ) { board_type = BOARD_TYPE_PI4B;}

   if ( strcmp(szBuff, "29020e0") == 0 ) { board_type = BOARD_TYPE_PI3APLUS;}
   if ( strcmp(szBuff, "2a02082") == 0 ) { board_type = BOARD_TYPE_PI3B;}
   if ( strcmp(szBuff, "2a22082") == 0 ) { board_type = BOARD_TYPE_PI3B;}
   if ( strcmp(szBuff, "2a32082") == 0 ) { board_type = BOARD_TYPE_PI3B;}
   if ( strcmp(szBuff, "2a52082") == 0 ) { board_type = BOARD_TYPE_PI3B;}
   if ( strcmp(szBuff, "2a020d3") == 0 ) { board_type = BOARD_TYPE_PI3BPLUS;}

   if ( strcmp(szBuff, "1900093") == 0 ) { board_type = BOARD_TYPE_PIZERO;}
   if ( strcmp(szBuff, "19000c1") == 0 ) { board_type = BOARD_TYPE_PIZEROW;}
   if ( strcmp(szBuff, "2900092") == 0 ) { board_type = BOARD_TYPE_PIZERO;}

   if ( strcmp(szBuff, "2900093") == 0 ) { board_type = BOARD_TYPE_PIZERO;}
   if ( strcmp(szBuff, "29000c1") == 0 ) { board_type = BOARD_TYPE_PIZEROW;}
   if ( strcmp(szBuff, "2902120") == 0 ) { board_type = BOARD_TYPE_PIZERO2;}

   if ( strcmp(szBuff, "2920092") == 0 ) { board_type = BOARD_TYPE_PIZERO;}
   if ( strcmp(szBuff, "2920093") == 0 ) { board_type = BOARD_TYPE_PIZERO;}

   if ( strcmp(szBuff, "2a01040") == 0 ) { board_type = BOARD_TYPE_PI2B;}
   if ( strcmp(szBuff, "2a21041") == 0 ) { board_type = BOARD_TYPE_PI2BV11;}
   if ( strcmp(szBuff, "2a01041") == 0 ) { board_type = BOARD_TYPE_PI2BV11;}
   if ( strcmp(szBuff, "2a22042") == 0 ) { board_type = BOARD_TYPE_PI2BV12;}
   
   strncpy(szBuff, str_get_hardware_board_name(board_type), 255);
   if ( szBuff[0] == 0 )
      strcpy(szBuff, "N/A");
