...
#define SHARED_MEM_TELEMETRY_RUBY_NAME "/SYSTEM_SHARED_MEM_RUBY_TELEMETRY"
#define SHARED_MEM_RUBY_TELEMETRY_EXTENDED_RETRANSMISSIONS "/SYSTEM_SHARED_MEM_RUBY_TELEMETRY_EXTENDED_RETR"
#define SHARED_MEM_TELEMETRY_FC_NAME "/SYSTEM_SHARED_MEM_FC_TELEMETRY"
#define SHARED_MEM_TELEMETRY_FC_EXTRA_NAME "/SYSTEM_SHARED_MEM_FC_EXTRA_TELEMETRY"
#define SHARED_MEM_TELEMETRY_FC_RC_CHANNELS "/SYSTEM_SHARED_MEM_FC_RC_CHANNELS"
...
#define MAX_INTERVALS_VIDEO_BITRATE_HISTORY 50
...
typedef struct
{
   ...
   u16 uHistTotalVideoBitrateKb[MAX_INTERVALS_VIDEO_BITRATE_HISTORY]; // video data + EC + radio headers
...
t_packet_header_ruby_telemetry_extended* shared_mem_ruby_telemetry_open_for_write();
t_packet_header_ruby_telemetry_extended* shared_mem_ruby_telemetry_open_for_read();
void shared_mem_ruby_telemetry_close(t_packet_header_ruby_telemetry_extended* pAddress);

t_packet_header_ruby_telemetry_extended_extra_info_retransmissions* shared_mem_ruby_telemetry_extra_retr_open_for_write();
t_packet_header_ruby_telemetry_extended_extra_info_retransmissions* shared_mem_ruby_telemetry_extra_retr_open_for_read();
