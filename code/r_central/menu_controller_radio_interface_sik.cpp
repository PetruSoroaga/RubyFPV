...
:Menu(MENU_ID_CONTROLLER_RADIO_INTERFACE_SIK, "Controller Radio Interface Settings", NULL)
{
   m_Width = 0.3;
   m_xPos = 0.08;
   m_yPos = 0.1;
...
void MenuControllerRadioInterfaceSiK::valuesToUI()
{
   ...
   int iRadioLinkId = g_pSM_RadioStats->radio_interfaces[m_iInterfaceIndex].assignedRadioLinkId;
   ...
   else
   {
      ...
      {
         if ( (NULL == g_pSM_RadioStats) || (g_pSM_RadioStats->radio_interfaces[i].assignedRadioLinkId != iRadioLinkId) )
            continue;
