...
:Menu(MENU_ID_VEHICLE_OSD_ELEMENTS, "OSD Elements", NULL)
{
   ...
   if ( g_pCurrentModel->vehicle_type != MODEL_TYPE_AIRPLANE )
   ...
   m_ExtraHeight = 1.2 * g_pRenderEngine->getMessageHeight("H", 0.0, MENU_TEXTLINE_SPACING, getUsableWidth(), g_idFontMenu);
}
...
void MenuVehicleOSDElements::valuesToUI()
{
   ...
   m_pItemsSelect[25]->setSelection((g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_BGBARS)?1:0);

   m_pItemsSelect[1]->setSelection((g_pCurrentModel->osd_params.osd_flags[layoutIndex] & OSD_FLAG_SHOW_BATTERY)?1:0);
   m_pItemsSelect[2]->setSelection((g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_BATTERY_CELLS)?1:0);
   ...
   m_pItemsSelect[9]->setSelection((g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_GPS_POS)?1:0);
   if ( g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_GPS_POS )
   ...
   if ( (g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_BARS) &&
        (g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_PERCENTAGE) )
      m_pItemsSelect[20]->setSelectedIndex(2);
   else if ( g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_BARS )
   ...
   if ( (g_pCurrentModel->osd_params.osd_flags[layoutIndex] & OSD_FLAG_SHOW_RADIO_INTERFACES_INFO) &&
        (g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_RADIO_LINK_INTERFACES_EXTENDED) )
   ...
   m_pItemsSelect[34]->setSelection((g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_RC_RSSI)?1:0);
   ...
   m_pItemsSelect[32]->setSelectedIndex((g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_LAYOUT_LEFT_RIGHT)?1:0);
   m_pItemsSelect[33]->setSelectedIndex(0);
   if ( (g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_GROUND_SPEED) &&
        (g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_AIR_SPEED) )
      m_pItemsSelect[33]->setSelectedIndex(3);
   else if ( g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_GROUND_SPEED )
      m_pItemsSelect[33]->setSelectedIndex(1);
   else if ( g_pCurrentModel->osd_params.osd_flags2[layoutIndex] & OSD_FLAG_EXT_SHOW_AIR_SPEED )
   ...
   else
   {
      ...
      if ( (g_pCurrentModel->vehicle_type != MODEL_TYPE_AIRPLANE) && (g_pCurrentModel->vehicle_type != MODEL_TYPE_DRONE) )
         m_pItemsSelect[28]->setEnabled(false);
      else
...
void MenuVehicleOSDElements::Render()
{
   ...
   for( int i=m_ItemsCount/2; i<m_ItemsCount; i++ )
      y += RenderItem(i, y, getUsableWidth() + 3*MENU_MARGINS*menu_getScaleMenus()/g_pRenderEngine->getAspectRatio());
...
void MenuVehicleOSDElements::onSelectItem()
{
   ...
   if ( m_IndexOSDOrientation == m_SelectedIndex )
   {
      if ( 0 == m_pItemsSelect[32]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_LAYOUT_LEFT_RIGHT;
      else
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_LAYOUT_LEFT_RIGHT;
      sendToVehicle = true;
   }
   ...
   if ( m_IndexShowBg == m_SelectedIndex )
   {
      if ( 0 == m_pItemsSelect[25]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_BGBARS;
      else
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_BGBARS;
      sendToVehicle = true;
   }
   ...
   if ( m_IndexVoltagePerCell == m_SelectedIndex )
   {
      if ( 0 == m_pItemsSelect[2]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_BATTERY_CELLS;
      else
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_BATTERY_CELLS;
      sendToVehicle = true;
   }
   ...
   if ( m_IndexSpeed == m_SelectedIndex )
   {
      ...
      {
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_GROUND_SPEED;
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_AIR_SPEED;
      }
   ...
   if ( m_IndexShowGPSPos == m_SelectedIndex )
   {
      if ( 0 != m_pItemsSelect[9]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_GPS_POS;
      else
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_GPS_POS;
   ...
   {
      params.osd_flags2[layoutIndex] &= ~(OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_BARS | OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_PERCENTAGE);
      if ( 0 == m_pItemsSelect[20]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_BARS;
      else if ( 1 == m_pItemsSelect[20]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_PERCENTAGE;
      else
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_BARS | OSD_FLAG_EXT_SHOW_RADIO_LINK_QUALITY_PERCENTAGE;
   ...
   if ( m_IndexRadioInterfaces == m_SelectedIndex )
   {
      if ( 0 == m_pItemsSelect[21]->getSelectedIndex() )
      {
         ...
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_RADIO_LINK_INTERFACES_EXTENDED;
      }
   ...
   if ( m_IndexRCRSSI == m_SelectedIndex )
   {
      if ( 0 == m_pItemsSelect[34]->getSelectedIndex() )
         params.osd_flags2[layoutIndex] &= ~OSD_FLAG_EXT_SHOW_RC_RSSI;
      else
         params.osd_flags2[layoutIndex] |= OSD_FLAG_EXT_SHOW_RC_RSSI;
      sendToVehicle = true;
   }
