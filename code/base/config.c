...
u32 channels433[] = {425, 426, 427, 428, 429, 430, 431, 432, 433, 434, 435, 435, 437, 438, 439, 440};
u32 channels868[] = {858,859,860, 861, 862, 863, 864, 865, 866, 867, 868, 869, 870, 871, 872, 873, 874, 875};
u32 channels915[] = {910,911,912,913,914,915,916,917,918,919,920};

u32 channels23[] = { 2312, 2317, 2322, 2327, 2332, 2337, 2342, 2347, 2352, 2357, 2362, 2367, 2372, 2377, 2382, 2387, 2392, 2397, 2402, 2407 };
u32 channels24[] = { 2412, 2417, 2422, 2427, 2432, 2437, 2442, 2447, 2452, 2457, 2462, 2467, 2472, 2484 };
u32 channels25[] = { 2487, 2489, 2492, 2494, 2497, 2499, 2512, 2532, 2572, 2592, 2612, 2632, 2652, 2672, 2692, 2712 };
u32 channels58[] = { 5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320, 5500, 5520, 5540, 5560, 5580, 5600, 5620, 5640, 5660, 5680, 5700, 5745, 5765, 5785, 5805, 5825, 5845, 5865, 5885 };
...
u32 getRealDataRateFromRadioDataRate(int dataRate)
{
   ...
   {
      if ( dataRate <= 56 )
         return ((u32)(dataRate))*1000*1000;
      return (u32)dataRate;
   }
   else if ( dataRate < 0 )
      return getRealDataRateFromMCSRate(-dataRate-1);
   else
      return 0;
}
