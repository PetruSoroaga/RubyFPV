...
#define SYSTEM_SW_BUILD_NUMBER  230
...
#define DEFAULT_RADIO_FRAMES_FLAGS (RADIO_FLAGS_FRAME_TYPE_DATA)
...
#define DEFAULT_PRIORITY_THREAD_RADIO_RX 45 // of 99
#else
#define DEFAULT_PRIORITY_THREAD_RADIO_RX 50 // of 99
#endif
#define DEFAULT_PRIORITY_THREAD_RADIO_TX 10 // of 99
#define DEFAULT_PRIORITY_THREAD_ROUTER 40
