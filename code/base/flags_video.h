...
#define VIDEO_PROFILE_ENCODING_FLAG_KEEP_CONSTANT_BITRATE ((u32)(((u32)0x01)<<31))

#define VIDEO_STATUS_FLAGS2_HAS_DEBUG_TIMESTAMPS ((u32)(((u32)0x01)<<8))
#define VIDEO_STATUS_FLAGS2_IS_END_OF_TRANSMISSION_FRAME ((u32)(((u32)0x01)<<9))
#define VIDEO_STATUS_FLAGS2_IS_ON_LOWER_BITRATE ((u32)(((u32)0x01)<<10))

#define VIDEO_STATUS_FLAGS2_MASK_NAL_FLAGS (((u32)(0x1F))<<11)
#define VIDEO_STATUS_FLAGS2_NAL_END ((u32)(((u32)0x01)<<11))
#define VIDEO_STATUS_FLAGS2_NAL_START ((u32)(((u32)0x01)<<12))
#define VIDEO_STATUS_FLAGS2_CONTAINS_I_NAL ((u32)(((u32)0x01)<<13))
#define VIDEO_STATUS_FLAGS2_CONTAINS_P_NAL ((u32)(((u32)0x01)<<14))
#define VIDEO_STATUS_FLAGS2_CONTAINS_SPS_NAL ((u32)(((u32)0x01)<<15))
