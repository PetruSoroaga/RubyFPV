...
#define DEFAULT_VIDEO_AUTO_INITIAL_KEYFRAME_INTERVAL 200 // in miliseconds
#define DEFAULT_VIDEO_KEYFRAME_INTERVAL_WHEN_RELAYING 200 // in miliseconds

#define DEFAULT_VIDEO_RETRANS_MS5_HP ((u32)10)  // 10*5 = 50 milisec
#define DEFAULT_VIDEO_RETRANS_MS5_HQ ((u32)10)  // 10*5 = 50 milisec
#define DEFAULT_VIDEO_RETRANS_MS5_MQ ((u32)10)  // 10*5 = 50 milisec
#define DEFAULT_VIDEO_RETRANS_MS5_LQ ((u32)10)  // 10*5 = 50 milisec
