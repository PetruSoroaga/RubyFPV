...
void MenuVehicleManagement::onShow()
{
   ...
   m_IndexReset  = addMenuItem(new MenuItem("Reset to defaults", "Resets all parameters for this vehicle to the default configuration (except for frequency, vehicle ID and RC control params)."));
