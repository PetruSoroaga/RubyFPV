...
float osd_render_stats_adaptive_video_get_height()
{
   ...
   if ( NULL == g_pCurrentModel || NULL == g_pSM_ControllerAdaptiveVideoInfo )
   {
...
void osd_render_stats_adaptive_video(float xPos, float yPos)
{
   ...
   sprintf(szBuff, "%u ms/bar", g_pSM_ControllerAdaptiveVideoInfo->uUpdateInterval);
   g_pRenderEngine->drawTextLeft(rightMargin, yPos, s_idFontStatsSmall, szBuff);
   

   int iIntervalsDown = g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame1 & 0xFFFF;
   int iIntervalsUp = (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame1 >> 16) & 0xFFFF;

   int iIntervalsAdaptiveDown = g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive1 & 0xFFFF;
   int iIntervalsAdaptiveUp = (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive1 >> 16) & 0xFFFF;
   ...
   int iMaxValue = 0;
   int iIndex = g_pSM_ControllerAdaptiveVideoInfo->uCurrentIntervalIndex;
   for( int i=0; i<iValuesToShow; i++ )
   {
      ...
      if ( iIndex < 0 )
       ...
       if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputCleanVideoPackets[iIndex] + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputRecontructedVideoPackets[iIndex]*3 + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsMissingVideoPackets[iIndex] > iMaxValue )
          iMaxValue = g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputCleanVideoPackets[iIndex] + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputRecontructedVideoPackets[iIndex]*3 + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsMissingVideoPackets[iIndex];
   }
   if ( iMaxValue == 0 )
      iMaxValue = 1;
   ...
   iIndex = g_pSM_ControllerAdaptiveVideoInfo->uCurrentIntervalIndex;
   for( int i=0; i<iValuesToShow; i++ )
   {
      iIndex--;
      if ( iIndex < 0 )
      ...
      float hBarOk = hGraph * (float)g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputCleanVideoPackets[iIndex]/(float)iMaxValue;
      float hBarRec = hGraph * (float)g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputRecontructedVideoPackets[iIndex]*3/(float)iMaxValue;
      float hBarMissing = hGraph * (float)g_pSM_ControllerAdaptiveVideoInfo->uIntervalsMissingVideoPackets[iIndex]/(float)iMaxValue;
 
      if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputCleanVideoPackets[iIndex] > 0 )
      {
      ...
      if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsOuputRecontructedVideoPackets[iIndex] > 0 )
      {
      ...
      if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsMissingVideoPackets[iIndex] > 0 )
      {
   ...
   for( int i=0; i<iValuesToShow; i++ )
   {
      ...
      if ( iIndex < 0 )
       ...
       if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRequestedRetransmissions[iIndex] + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRetriedRetransmissions[iIndex] > iMaxValue )
          iMaxValue = g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRequestedRetransmissions[iIndex] + g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRetriedRetransmissions[iIndex];
   }
   ...
   for( int i=0; i<iValuesToShow; i++ )
   {
      ...
      float hBarReq = hGraph * (float)g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRequestedRetransmissions[iIndex]/(float)iMaxValue;
      float hBarRetry = hGraph * (float)g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRetriedRetransmissions[iIndex]/(float)iMaxValue;
      
      if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRequestedRetransmissions[iIndex] > 0 )
      {
      ...
      if ( g_pSM_ControllerAdaptiveVideoInfo->uIntervalsRetriedRetransmissions[iIndex] > 0 )
      {
   ...
   sprintf(szBuff, "%d", g_pSM_ControllerAdaptiveVideoInfo->iChangeStrength);
   ...
   if ( g_TimeNow >= g_pSM_ControllerAdaptiveVideoInfo->uLastUpdateTime )
      sprintf(szBuff, "%u ms ago", g_TimeNow - g_pSM_ControllerAdaptiveVideoInfo->uLastUpdateTime );
   else if ( g_pSM_ControllerAdaptiveVideoInfo->uLastUpdateTime != 0 )
   ...
   if ( ( g_TimeNow < g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame ) ||
        ( g_TimeNow - g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame < 500 ) )
      g_pRenderEngine->setColors(get_Color_IconError());
      
   g_pRenderEngine->drawText(xPos, y, s_idFontStats, "KF Last Change Time:");
   if ( 0 == g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame )
      strcpy(szBuff, "Never");
   else if ( g_TimeNow < g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame )
      strcpy(szBuff, "[0] ms ago");
   else if ( g_TimeNow - g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame < 5000 )
      sprintf(szBuff, "%u ms ago", g_TimeNow - g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame );
   else
      sprintf(szBuff, "%u s ago", (g_TimeNow - g_pSM_ControllerAdaptiveVideoInfo->uTimeLastRequestedKeyFrame) / 1000 );
   
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;

   g_pRenderEngine->drawText(xPos, y, s_idFontStats, "KF Last Changed Value:");
   sprintf(szBuff, "%d", g_pSM_ControllerAdaptiveVideoInfo->iLastRequestedKeyFrame);
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;
   ...
   sprintf(szBuff, "%u / %u of %u", (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame1 >> 16 ) & 0xFFFF, g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame1 & 0xFFFF, MAX_CONTROLLER_ADAPTIVE_VIDEO_INFO_INTERVALS );
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;

   g_pRenderEngine->drawText(xPos, y, s_idFontStats, "KF current U/D values:");
   sprintf(szBuff, "%u / %u, %u", g_pSM_ControllerAdaptiveVideoInfo->uCurrentKFMeasuredThUp1, g_pSM_ControllerAdaptiveVideoInfo->uCurrentKFMeasuredThDown1, g_pSM_ControllerAdaptiveVideoInfo->uCurrentKFMeasuredThDown2);
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;

   g_pRenderEngine->drawText(xPos, y, s_idFontStats, "KF Thresholds Move Up:");
   if ( iIntervalsUp > 0 )
      sprintf(szBuff, "%u (%d%%)", g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame2 & 0xFF, ((int)(g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame2 & 0xFF))*100/iIntervalsUp );
   else
      sprintf(szBuff, "%u", g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame2 & 0xFF );
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;

   g_pRenderEngine->drawText(xPos, y, s_idFontStatsSmall, "KF Thresholds Move Down:");
   sprintf(szBuff, "%u / %u / %u / %u",
      (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame2 >> 8) & 0xFF,
      (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame2 >> 16) & 0xFF,
      (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame3 ) & 0xFF,
      (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsKeyFrame3 >> 8) & 0xFF );
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;
   ...
   g_pRenderEngine->drawText(xPos, y, s_idFontStats, "Video Lookup Intervals U/D:");
   ...
   if ( adaptiveVideoIsOn )
      sprintf(szBuff, "%u / %u of %d", (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive1 >> 16 ) & 0xFFFF, g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive1 & 0xFFFF, MAX_CONTROLLER_ADAPTIVE_VIDEO_INFO_INTERVALS );
   else
   ...
   if ( adaptiveVideoIsOn )
      sprintf(szBuff, "%u, %u", (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive2 & 0xFF ), (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive2 >> 8) & 0xFF );
   else
      strcpy(szBuff, "Disabled");
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;
   ...
   if ( adaptiveVideoIsOn )
      sprintf(szBuff, "%u, %u", (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive2>>16) & 0xFF, (g_pSM_ControllerAdaptiveVideoInfo->uIntervalsAdaptive2 >> 24) & 0xFF );
   else
      strcpy(szBuff, "Disabled");
   g_pRenderEngine->drawTextLeft(rightMargin, y, s_idFontStats, szBuff);
   y += height_text*s_OSDStatsLineSpacing;
...
void osd_render_stats_video_bitrate_history(float xPos, float yPos)
{
   ...
   for( int i=0; i<(int)g_SM_DevVideoBitrateHistory.uSlices; i++ )
   {
      ...
      if ( g_SM_DevVideoBitrateHistory.uHistTotalVideoBitrateKb[i]/1000 > s_uMaxValueStatsDevVideoBitrate )
         s_uMaxValueStatsDevVideoBitrate = g_SM_DevVideoBitrateHistory.uHistTotalVideoBitrateKb[i]/1000;
   }
   ...
   u32 uPrevDatarate = g_SM_DevVideoBitrateHistory.uHistMaxVideoDataRateMbps[0];
   u32 uPrevVideoBitrate = g_SM_DevVideoBitrateHistory.uHistVideoBitrateKb[0]/1000;
   u32 uPrevTotalBitrate = g_SM_DevVideoBitrateHistory.uHistTotalVideoBitrateKb[0]/1000;
   float hDataratePrev = 0.0;
   float hDatarateLowPrev = 0.0;
   float hVideoBitratePrev = 0.0;
   float hTotalBitratePrev = 0.0;
   ...
   for( int i=0; i<(int)g_SM_DevVideoBitrateHistory.uSlices; i++ )
   {
      ...
      float hTotalBitrate = g_SM_DevVideoBitrateHistory.uHistTotalVideoBitrateKb[i]*hGraph/s_uMaxValueStatsDevVideoBitrate/1000.0;
      if ( i == 0 )
      {
      ...
      else
      {
         ...
         g_pRenderEngine->drawLine(xBarMiddle, y+hGraph-hVideoBitrate, xBarMiddle+widthBar, y+hGraph-hVideoBitratePrev);

         g_pRenderEngine->setStroke(255,250,220, s_fOSDStatsGraphLinesAlpha);
         g_pRenderEngine->drawLine(xBarMiddle, y+hGraph-hTotalBitrate, xBarMiddle+widthBar, y+hGraph-hTotalBitratePrev);
      ...
      uPrevDatarate = g_SM_DevVideoBitrateHistory.uHistMaxVideoDataRateMbps[i];
      uPrevVideoBitrate = g_SM_DevVideoBitrateHistory.uHistVideoBitrateKb[i]/1000;
      uPrevTotalBitrate = g_SM_DevVideoBitrateHistory.uHistTotalVideoBitrateKb[i]/1000;

      hDataratePrev = hDatarate;
      hDatarateLowPrev = hDatarateLow;
      hVideoBitratePrev = hVideoBitrate;
      hTotalBitratePrev = hTotalBitrate;
      xBarMiddle -= widthBar;
   }
   ...
   g_pRenderEngine->drawText(xPos, y, height_text, s_idFontStats, "Auto Adjustments:");
   y += height_text*0.6;
   y += height_text*s_OSDStatsLineSpacing;
   ...
   g_pRenderEngine->setFill(pc[0], pc[1], pc[2], s_fOSDStatsGraphLinesAlpha);
   //g_pRenderEngine->drawLine(xPos+dxGraph, y, xPos + dxGraph + widthGraph, y);         
   //g_pRenderEngine->drawLine(xPos+dxGraph, y+hGraph2, xPos + dxGraph + widthGraph, y+hGraph2);
   ...
   for( int i=0; i<(int)g_SM_DevVideoBitrateHistory.uSlices; i++ )
   {
           ...
           (i > 0 && g_SM_DevVideoBitrateHistory.uHistVideoQuantization[i-1] == 0xFF ) )
      {
         ...
         g_pRenderEngine->setFill(pc[0], pc[1], pc[2], s_fOSDStatsGraphLinesAlpha*0.6);
