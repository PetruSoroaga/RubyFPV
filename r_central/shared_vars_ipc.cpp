...
t_packet_header_ruby_telemetry_extended* g_pPHRTE = NULL;
t_packet_header_ruby_telemetry_extended_extra_info_retransmissions* g_pPHRTE_Retransmissions = NULL;
t_packet_header_fc_telemetry* g_pdpfct = NULL;
t_packet_header_fc_extra* g_pdpfce = NULL;
t_packet_header_fc_rc_channels* g_pPHFCRCChannels = NULL;
