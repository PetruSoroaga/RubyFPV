...
void osd_show_HID()
{
   ...
   {
      percentX1 = ((float)g_pPHFCRCChannels->channels[0]-1000.0)/1000.0;
      percentY1 = ((float)g_pPHFCRCChannels->channels[1]-1000.0)/1000.0;
      percentX2 = ((float)g_pPHFCRCChannels->channels[3]-1000.0)/1000.0;
      percentY2 = ((float)g_pPHFCRCChannels->channels[2]-1000.0)/1000.0;
   ...
   for( int i=4; i<=maxCh; i++ )
   {
      ...
      if ( bShowMAVLink && NULL != g_pPHFCRCChannels )
      {
         percent = ((float)g_pPHFCRCChannels->channels[i]-1000.0)/1000.0;
